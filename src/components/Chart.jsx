...
export const BarChart = ({
	...
	return <Bar grid width={horizontal ? "200%" : "2000"} height={800} options={options} data={data} />;
};
...
// exporting bar component
export const LineChart = ({ data, label, backgroundColor, borderColor, labels, legend = false,tension = 0 }) => {
	const options = {
		responsive: true,
		tension:tension,
		plugins: {
