...
const levelData = [
	...
	{
		data: ["Level 1", "1x2x580", "300", "-----------", "-----------"],
		_id: "Level-101",
	},
	{
		data: ["Level 2", "300X2X2=4X580", "300", "-----------", "-----------"],
		_id: "Level-101",
	},
	{
		data: ["Level 3", "300X4X2=8X580", "300", "-----------", "-----------"],
		_id: "Level-101",
	},
	{
		data: ["Level 4", "300X8X2=16X580", "300", "-----------", "-----------"],
		_id: "Level-101",
	},
	{
		data: ["Level 5", "300X16X2=32X580", "300", "-----------", "-----------"],
		_id: "Level-101",
	},
	{
		data: ["Level 7", "300X32X2=64X580", "300", "-----------", "-----------"],
		_id: "Level-101",
	},
	{
		data: ["Level 8", "128X2=256X580", "300", "-----------", "-----------"],
		_id: "Level-101",
	},
	{
		data: ["Level 9", "256X2=512X580", "300", "-----------", "-----------"],
		_id: "Level-101",
	},
	{
			...
			<main className="dashboard">
				...
				{user?.role === "admin" ? (
					<section className="widget-container">
						...
						/>
						<WidgetItem
							value={user?.epinManager?.epin?.length}
							heading="E-Pin"
							color="rgba(0,115,255)"
							path="M16.6443 2.02014C20.0323 2.02014 22.3093 4.39814 22.3093 7.93714V16.1041C22.3093 19.6431 20.0323 22.0201 16.6433 22.0201H7.97527C4.58627 22.0201 2.30927 19.6431 2.30927 16.1041V7.93714C2.30927 4.39814 4.58627 2.02014 7.97527 2.02014H16.6443ZM9.15027 9.41914C7.71627 9.41914 6.54926 10.5861 6.54926 12.0201C6.54926 13.4551 7.71627 14.6221 9.15027 14.6221C10.3223 14.6221 11.3043 13.8381 11.6283 12.7701H13.7403V13.8721C13.7403 14.2861 14.0763 14.6221 14.4903 14.6221C14.9043 14.6221 15.2403 14.2861 15.2403 13.8721V12.7701H16.5703V13.8721C16.5703 14.2861 16.9063 14.6221 17.3203 14.6221C17.7343 14.6221 18.0703 14.2861 18.0703 13.8721V12.0201C18.0703 11.6061 17.7343 11.2701 17.3203 11.2701H11.6283C11.3043 10.2031 10.3223 9.41914 9.15027 9.41914ZM9.15037 10.919C9.75737 10.919 10.2524 11.413 10.2524 12.021C10.2524 12.628 9.75737 13.122 9.15037 13.122C8.54337 13.122 8.04837 12.628 8.04837 12.021C8.04837 11.413 8.54337 10.919 9.15037 10.919Z"
						/>
						<WidgetItem
				...
				<section className="ongoing">
					<TableContainer className="ongoingEventTableContainer">
						<TableHeading>
							<p>Ongoing Events</p>
							{/* <Select
								defaultValue={ongoingEventSortOptions[0]}
								options={ongoingEventSortOptions}
								components={{ DropdownIndicator }}
					...
					<section className="levels">
						<TableContainer className="dashboardOngoingEventTableContainer">
							...
							<Table>
								...
								/>
								<TableBody TableRow={LevelRow} data={levelData} />
							</Table>
						</TableContainer>
						{/* {Table()} */}
					</section>
